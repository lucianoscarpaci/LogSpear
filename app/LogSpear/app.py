        ...
        for log in logs:
            ...
            if log.get("suspicious_activity"):
                ...
                if log.get("connected_devices"):
                    botnet_connections[log.get("ip_address")] = log.get("connected_devices")
            else:
...
def create_botnet_graph(botnet_connections: dict, suspicious_devices: list) -> go.Figure:
                ...
                try:
                    ...
                    if parsed_data['suspicious_count'] > 0:
                        ...
                        await cl.Message(
                            ...
                            elements=[cl.Plotly(name="botnet_graph", figure=fig, display="inline")]
                        ).send()
